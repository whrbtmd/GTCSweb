...
newMomentProto.format = function() {
	...
	if (this._ambigZone) {
		return oldMomentFormat(this, 'YYYY-MM-DD[T]HH:mm');
	}
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	renderSlatRowHtml: function() {
		...
		while (slotTime < this.maxTime) {
			...
			html +=
				'<tr data-time="' + slotDate.format('HH:mm') + '"' +
	...
	renderSelection: function(span) {
		if (this.view.opt(' ')) { // this setting signals that a mock helper event should be rendered
...
var BasicView = FC.BasicView = View.extend({
	...
	weekNumbersVisible: true, // display week numbers along the side?
