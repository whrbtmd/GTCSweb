...
$.fn.zabuto_calendar_language = function (lang) {
    ...
    switch (lang.toLowerCase()) {
        case 'de':
            return {
                month_labels: ["Januar", "Februar", "M채rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"],
        ...
        case 'es':
            return {
                ...
                dow_labels: ["Lu", "Ma", "Mi", "Ju", "Vi", "S찼", "Do"]
            };
            break;

        case 'fr':
            return {
                month_labels: ["Janvier", "F챕vrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Ao청t", "Septembre", "Octobre", "Novembre", "D챕cembre"],
