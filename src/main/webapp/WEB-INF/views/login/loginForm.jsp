...
$(document).ready(function(){
     ...
     $("#login").on("click", function(){
         ...
         formObj.attr("action", "loginProcess");
         formObj.submit();
        });
...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap ">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="userid" id="userid"  required class="frm_input " maxlength="20">
            </td>
        </tr>
        <tr>
...
<br /><br />
    ...
    <div class="btn_confirm">
        <button type="submit" value="로그인" id="login" class="btn_submit">로그인</button>
