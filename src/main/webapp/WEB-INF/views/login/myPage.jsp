...
<body>
<h1><center>내 정보 수정</center></h1>
<form role="form" method="post" class="form-inline" align="center" id="form-inline">

<fieldset>
<label for="userid">회원아이디 </label>
   		<input type="text" value="${sessionScope.userid}" name="userid" class="form-control" id="userid" readonly><br>
   		<input type="hidden" value="${gemember.userid}" name="userid">
  	<br>
<label for="userpw">비밀번호 </label>
   		<input type="text" value="${gemember.userpw}" name="userpw" class="form-control" id="userpw"><br>
  	<br>
<label for="username">회원명 </label>
   		<input type="text" value="${gemember.username}" name="username" class="form-control" id="username"><br>
  	<br>
...
<label for="address">회원 거주지 </label>
	...
	<c:choose>
		...
		<c:when test="${userid == sessionScope.userid}">
			<div align="center">
