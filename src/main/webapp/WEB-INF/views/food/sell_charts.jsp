...
<div class="grandparent" style="margin-top:18%">    
                    <!--페이지내용-->
                  <div class="order_chart" style="width:100%; display:inline" >
                      <select onchange="if(this.value) location.href=(this.value);">
                        <option style="display:none" value="" selected>선택</option>
                        <option value="order_charts.html">품목별 판매현황</option>
                        <option value="sell_charts.html">판매금액</option> 
                      </select>
                      <button style="width:70px;height:35px; margin-left:5px;" class="sellChartReset"><p style="font-size:15px">초기화</p></button>
                    </div>
                    <br>
                      <select style="width:70px;height:40px;" onchange="if(this.value) location.href=(this.value);">
                        <option style="display:none" value="" selected>주/월</option>
                        <option value="sell_charts.html">주간</option> 
                        <option value="sell_charts_month.html">월간</option> 
                      </select>
    ...
    <script src="./resources/js/highchartsm.js"></script>
