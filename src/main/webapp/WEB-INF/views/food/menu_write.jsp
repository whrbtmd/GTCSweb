...
<jsp:forward page="/resources/menu_write.html" />
...
<div class="grandparent">    
                    <!--페이지내용-->
                <div class="Write" style="width:100% ; overflow-y:auto; margin-bottom:60px">
                        <p>메뉴이름</p>
                        <input type="text" class="writeTxtFood_name" placeholder="메뉴이름을 입력하세요">
                        <p>가격</p>
                        <input type="number" class="writeTxtPrice" placeholder="가격을 입력하세요">
                            <div class="UploadButtons">
                            <button class="uploadBtnUpload">이미지 업로드</button>
                            <div class="Images">
                    ...
                    <form onsubmit="return false" oninput="level.value = flevel.valueAsNumber">
                        ...
                        <input name="flevel" type="range" id="flying" class="writeTxtSize" placeholder="사이즈를 입력하세요" min="1" max="4" step="1" value="1">
                        <output for="flying" name="level">1</output>/4<br>
                        <select class="writeTxtLev">
                        <option value="1">음식</option>
                        <option value="2">음료</option>
                        </select>
                    </form>
                            <div class="ItemButtons">
                                <button class="writeBtnWrite">완료</button>
                                <button class="writeBtnCancel">취소</button>
                         </div>
                        </div>
                    </div>   
