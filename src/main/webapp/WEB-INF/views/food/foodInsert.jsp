...
$(document).ready(function(){
     ...
     $("#F").on("click", function(){
        alert("메뉴등록성공!");
         formObj.attr("action", "foodInsert");
         formObj.submit();
        });
...
<div id="sh_top_menu_wrapper">
   ...
   <div id="top_menu_wrapper">
      ...
      <ul id="top_menu">
                     ...
                     <li class="list list01"><a href="foodList">그늘집</a>
                        </li>
...
<!--             <th scope="row"><label for="imgFile">이미지<strong class="sound_only">필수</strong></label></th> -->
            <td><input type="file" name="imgFile" id="imgFile" maxlength="20"></td>
        </tr>
        
        <tr>
            <th scope="row"><label for="pfood_name">음식명<strong class="sound_only">필수</strong></label></th>
            <td>
                <input type="text" name="pfood_name" id="pfood_name" class="frm_input" maxlength="20">
            </td>
        </tr>
        
        <tr>
            <th scope="row"><label for="pfood_menu">구성<strong class="sound_only">필수</strong></label></th>
            <td>
                <select name="plev" id="plev" class="form-control">
            <option type="submit" name="pfood_menu_food" value=1>식사</option>
             <option type="submit" name="pfood_menu_drink"value=0>음료</option>
               </select>
            </td>
        </tr>
        
        <tr>
            <th scope="row"><label for="pprice">가격<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="pprice" id="pprice" required class="frm_input" maxlength="20"></td>
        </tr>
      
        <tr>
            <th scope="row"><label for="psize">size<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="psize" id="psize" required class="frm_input" maxlength="20"></td>
        </tr>
...
<br /><br />
    ...
    <div class="btn_confirm">
        <button type="submit" class="btn_submit" id="F">등록</button>
        <a href="foodList" class="btn_cancel">취소</a>
    </div>
    </form>
