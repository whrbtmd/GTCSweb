...
<title>GTCS/그늘집 메뉴-음료</title>
<link rel="stylesheet" href="http://lei1007.shiningcorp.com/css/default.css">
<link rel="stylesheet" href="http://lei1007.shiningcorp.com/skin/board/gallery02/style.css">
						...
						<div id="aside_tit">
							...
							<div id="l_menu">
								<ul>
									...
									<li class='l_menu_OFF' style=''><a href="drinkList">음료</a>
									</li>
...
<div id="bo_gall" style="width:100%">
    ...
    <form name="fboardlist" id="fboardlist" method="post">
				...
				<div>
					...
					<c:forEach items="${listd}" var="food">
						<ul id="sh_gall_ul">
