				...
				<div class="col-md-3 col-sm-4">
					<div class="product-item-categori">
						<div class="product-type">
							<h2>Product Type</h2>
							<ul>
								<li><a href="../shop/goodlist?category=Driver"><i
										class="fa fa-angle-right"></i>Driver</a></li>
								<li><a href="../shop/goodlist?category=Hybrid"><i
										class="fa fa-angle-right"></i>Hybrid</a></li>
								<li><a href="../shop/goodlist?category=IronSets"><i
										class="fa fa-angle-right"></i>IronSets</a></li>
								<li><a href="../shop/goodlist?category=putters"><i
...
<!-- 										</ul> -->
									...
									<div class="re-shop">
										<div class="sort-by">
<!-- 											<div class="shop6"> -->
<!-- 												<label>Sort By :</label> <select name="orderby" -->
<!-- 												onchange="document.location.href='?orderby='+this.value"> -->
<!-- 												<option value="def">Default sorting</option> -->
<!-- 													<option value="pop">Sort by popularity</option> -->
<!-- 													<option value="new">Sort by newness</option> -->
<!-- 													<option value="pri">Sort by price: low to high</option> -->
<!-- 												</select> -->
<!-- 											</div> -->
										</div>
										<div class="shop5">
										...
										<div class="single-item">
											<div class="product-item-img">
												...
												<a href="<c:url value="/shop/read?${query}"/> "> </a> <img
													...
													style="width: 150px; height: 150px" alt="" class="S" /> </a>
