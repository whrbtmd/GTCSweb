...
<title>GTCS/NOTICE-공지사항등록</title>
...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap ">
        ...
        <tbody>
        <tr>
            <th scope="row"><label for="writer">작성자<strong class="sound_only">필수</strong></label></th>
            <td>
                <input type="text" name="writer" id="writer" value="관리자" class="frm_input" maxlength="20">
            </td>
        </tr>
        
        <tr>
            <th scope="row"><label for=title>제목<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="title" id="title" required class="frm_input" maxlength="20"></td>
        </tr>
                
        <tr>
            <th scope="row"><label for="content">내용<strong class="sound_only">필수</strong></label></th>
            <td><textarea  name="content" id="content" required class="frm_input" rows="20" cols="50"></textarea></td>
        </tr>
