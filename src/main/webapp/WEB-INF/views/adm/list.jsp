...
.modal-footer {
	...
	<div class="form-group">
		<div class="col-sm-2" style="margin-left: 100px;">
			<center> <a href="list"><img
				src="../images/logo.png" width="190px;" height="80px;"></a></center>
		</div>
	</div>
				...
				<table align="center" class="top-main">
					<tr>
						<td align="center"><a href="#">메뉴</a> &nbsp;&nbsp; <a
							href="insert?category=DRIVERS">SHOP</a> &nbsp;&nbsp; <a
							href="./calendar/calendar">예 약</a> &nbsp;&nbsp; <a href="notice">공지사항</a>
							&nbsp;&nbsp; <c:choose>
								...
								<form role="form" action="loginProcess" method="post">
									...
									<div class="form-group">
										<label for="ppw"><span
											...
											type="text" class="form-control" id="pw" name="pw">
									</div>
