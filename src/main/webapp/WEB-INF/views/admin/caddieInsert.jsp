...
$(document).ready(function(){
     ...
     $("#caddieI").on("click", function(){
        alert("캐디 등록 성공!");
         formObj.attr("action", "caddieInsert");
         formObj.submit();
        });
...
<div class="mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap ">
        ...
        <caption>캐디등록</caption>
        <tbody>
        <tr>
            <th scope="row"><label for="userid">아이디<strong class="sound_only">필수</strong></label></th>
            <td><input type="text" name="userid" id="userid" required class="frm_input" maxlength="20"></td>
        </tr>
        
        <tr>
            <th scope="row"><label for="userpw">암호<strong class="sound_only">필수</strong></label></th>
            <td><input type="password" name="userpw" id="userpw" required class="frm_input" maxlength="20"></td>
        </tr>
                
        <tr>
            <th scope="row"><label for="username">캐디이름<strong class="sound_only">필수</strong></label></th>
            <td><input type="text"  name="username" id="username" required class="frm_input" rows="20" cols="50"></textarea></td>
        </tr>
        ...
        <tr>
            ...
            <td>
             ...
             <option type="submit" name="caddieMember">caddie</option>
               </select>
            </td>
        </tr>
...
<br /><br />
    ...
    <div class="btn_confirm">
        <button type="submit" class="btn_submit" id="caddieI" >등록</button>
        <a href="notice" class="btn_cancel">취소</a>
    </div>
    </form>
