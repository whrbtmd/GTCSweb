...
<script>
 $(document).ready(function(){
  ...
  $("#listAll").on("click", function(){
   ...
   formObj.attr("action", "adminReserDetail");
   formObj.submit();
...
캐디명 : 	<select name="cname">
        ...
        <div id="bo_v_bot">       
        <ul class="bo_v_com"><li><a href="adminReser" class="btn_b01">목록</a></li></ul>
        <ul class="bo_v_com"><li><button type="submit" class="btn_b01" id="gmodify">캐디배치</button></li></ul>
